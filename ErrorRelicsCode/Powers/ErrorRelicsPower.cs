...
namespace ErrorRelics.ErrorRelicsCode.Powers;
...
/// </summary>
public abstract class ErrorRelicsPower : CustomPowerModel
{
    //Loads from ErrorRelics/images/powers/your_power.png
